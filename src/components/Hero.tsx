...
export default function Hero() {
  return (
    <main className="flex-1 flex flex-col items-center justify-center px-4 py-20 text-center relative overflow-hidden">
      ...
      {/* Badge */}
      <div className="mb-6">
        <Badge icon="❖">Smart Culinary Cost Calculator</Badge>
      </div>
      ...
      <p className="mt-4 text-base sm:text-lg text-muted max-w-xl">
        Track ingredient prices, reduce food waste, and maximize your profit
        margins with real-time cost breakdown.
      </p>
