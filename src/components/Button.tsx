...
export default function Button({
  ...
  'aria-label': ariaLabel,
    ...
    const baseStyles = 'inline-flex items-center justify-center font-bold rounded-xl transition duration-150 focus:outline-none focus:ring-2 focus:ring focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none';
    ...
    const variants = {
        ...
        destructive: 'bg-red-600 hover:bg-red-700 text-white px-6 py-3 shadow-md shadow-red-600/20 focus:ring-red-500',
    };
